...
<head>
    <title>freshersjob- Online HR Portal</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../index.html">
            <img class="logo-one" src="../assets/logo and favicon/freshers-job-logo.jpg" alt="Navbar logo" />
        </a>
    ...
    <footer id="contact">
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <a href="../index.html">
                            <img class="logo2" src="../assets/logo and favicon/freshers-job-logo.jpg" alt="footer logo" />
                        </a>
                        <p class="content1">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptatibus pariatur aut, reiciendis magnam non delectus quod iste ea animi corrupti sunt vitae eligendi et libero quidem officiis eveniet. Numquam temporibus quo fugit cupiditate ipsam corporis, rem aut. Laborum perferendis ut molestiae reprehenderit vitae recusandae dolor aspernatur ex aliquid animi.
                            <br /><br />
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus harum, sint corporis deleniti mollitia ut dignissimos in quasi quo illo!
                        </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="social-icons">
                            ...
                            <p class="contact-details">
                                ...
                                freshersjob@gmail.com <br /><br />
                                <i class="fa fa-phone" aria-hidden="true"></i> &nbsp;
                                +91-8989654323 <br /><br />
                                <i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp;
                                404, 5th-Floor, 93 Ashok Bhawan, Nehru Place, Delhi - 110019
                            </p>
                        </div>
                    </div>

                    <div class="col-lg-4 mt-3">
                        <h4>freshersjob.in</h4>
                        <div>
            ...
            <div class="footer2">
                freshersjob.in&nbsp;&copy;&nbsp;2020 All Rights Reserved.
            </div>
        </div>
    </footer>
